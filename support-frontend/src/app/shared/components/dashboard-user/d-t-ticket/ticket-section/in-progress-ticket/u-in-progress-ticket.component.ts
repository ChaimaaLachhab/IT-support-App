...
@Component({
  selector: 'app-u-in-progress-ticket',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  templateUrl: './u-in-progress-ticket.component.html',
  styleUrls: ['./u-in-progress-ticket.component.css']
})
export class UInProgressTicketComponent implements OnInit {
